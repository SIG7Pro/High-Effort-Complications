...
class MenuItem extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, weekNum:Int = 0)
	{
		...
		week.animation.addByPrefix('week3', "week23 select", 24);
		week.animation.addByPrefix('week4', "Week 3 press", 24);
		week.animation.addByPrefix('week5', "Week 4 press", 24);
		week.animation.addByPrefix('week6', "week 5", 24);
		week.animation.addByPrefix('week7', "Week 6", 24);
		week.animation.addByPrefix('week8', "WeekVoid", 24);
		week.animation.addByPrefix('week9', "balls", 24);
		add(week);
