...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'monster-christmas':
				...
				playAnim('idle');
			case 'opheebop-fix':
				tex = FlxAtlasFrames.fromSparrow('assets/images/brazil/ofix.png', 'assets/images/brazil/ofix.xml');
				frames = tex;
				animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
			...
			case 'austin':
				tex = FlxAtlasFrames.fromSparrow('assets/images/cry some more/austin_assets.png', 'assets/images/cry some more/austin_assets.xml');
				frames = tex;
				...
				addOffset('singUP', 161, 45);
				addOffset('singRIGHT', -18, -164);
				addOffset('singLEFT', 292, 14);
				addOffset('singDOWN', 0, -335);
				addOffset('singUPmiss', 153, 29);
				addOffset('singRIGHTmiss', 3, -151);
				addOffset('singLEFTmiss', 275, 13);
				addOffset('singDOWNmiss', -11, -300);

				playAnim('idle');

			case 'opheebop':
				var tex = FlxAtlasFrames.fromSparrow('assets/images/brazil/o.png', 'assets/images/brazil/o.xml');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'spong-final':
				var tex = FlxAtlasFrames.fromSparrow('assets/images/pine/PINEAPPLEPINEAPPLEPINEAPPLEPINEAPPLEP.png', 'assets/images/pine/PINEAPPLEPINEAPPLEPINEAPPLEPINEAPPLEP.xml');
				frames = tex;
				animation.addByPrefix('idle', 'spooky dance idle instance 1', 12, true);
				addOffset('idle');
				playAnim('idle');
	...
	{
		if((!flipX && (curCharacter.startsWith('bf') || curCharacter == 'opheebop')) || (flipX && !(curCharacter.startsWith('bf') || curCharacter == 'opheebop')))
			x = -x;
